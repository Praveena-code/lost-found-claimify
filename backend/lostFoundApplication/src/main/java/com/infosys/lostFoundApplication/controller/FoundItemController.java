...
public class FoundItemController {
	...
	public List<FoundItem> getFoundItemsByLostItem(@PathVariable String id) {
	    LostItem lostItem = lostItemDao.getLostItemById(id);
	    return foundItemRepository.searchByKeyword(lostItem.getCategory());
	}
	
	@PutMapping("/found/claim/{id}")
	public ResponseEntity<String> claimFoundItem(@PathVariable String id) {
	    foundItemRepository.updateStatusToClaimed(id);
